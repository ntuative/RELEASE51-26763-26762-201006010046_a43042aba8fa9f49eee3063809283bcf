package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1677 = param2;
         var_347 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_122,onBadgeImageReady);
         ...
         var_1881 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_347 != null)
         {
            var_347.events.removeEventListener(BadgeImageReadyEvent.const_122,onBadgeImageReady);
            var_347 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_707,var_1881);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1677.toString());
