package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1105:String = "badges";
      
      private static const const_1107:String = "pet_inventory";
      
      private static const const_1104:String = "pixelbalance";
      
      private static const const_1108:String = "credits";
      
      private static const const_1103:String = "inventory";
      
      private static const const_1101:String = "friendlist";
      
      private static const const_1102:String = "selectfurni";
      
      private static const const_1106:String = "selectbadge";
      ...
      private var var_412:HabboNotificationViewManager;
      
      private var var_706:ClubEndingNotification;
      ...
      private var var_705:ClubGiftNotification;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_705 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_889)
         {
            return;
         }
      ...
      {
         if(param1 != null && this.var_412 != null)
         {
            var_412.replaceIcon(param1);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1006,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_190 || param2.type == WindowEvent.const_631)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_412.isSpaceAvailable() && false)
         {
            var_412.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_1044.splice(0,1);
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1409,_loc5_);
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1044.push(_loc8_);
         return var_1044.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1242)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_706 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_594.events.addEventListener(HabboToolbarEvent.const_93,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_347.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_991);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_991);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_93)
         {
            ...
            var_412 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_847["styles"],var_847["view"],var_594);
            ...
            registerUpdateReceiver(var_412,1);
            registerUpdateReceiver(this,2);
            var_347.events.addEventListener(BadgeImageReadyEvent.const_122,onBadgeImage);
