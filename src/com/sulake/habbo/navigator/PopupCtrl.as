package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_368 = new Timer(500,1);
         var_318 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1150 = param4;
         var_1931 = param2;
         _popupIndentLeft = param3;
         var_368.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_368)
         {
            var_368.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_368.reset();
            var_368 = null;
         }
         if(var_318)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_50 == null)
         {
            var_50 = IWindowContainer(_navigator.getXmlWindow(var_1150));
            var_50.visible = false;
         ...
         var_50.x = _loc2_.x + var_1931 + param1.width;
