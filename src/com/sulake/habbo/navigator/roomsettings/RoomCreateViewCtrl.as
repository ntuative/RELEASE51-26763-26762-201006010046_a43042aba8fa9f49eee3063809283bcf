package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_470 = new Timer(100);
         var_470.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_994 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function method_15(param1:WindowEvent, param2:IWindow) : void
      {
      ...
      public function dispose() : void
      {
         if(var_470)
         {
            var_470.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_470.reset();
            var_470 = null;
         }
      }
      ...
      public function refresh() : void
      {
         ...
         var_994.input.textBackgroundColor = 4294967295;
         var_801 = var_40[0];
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_994.getText();
      ...
      {
         var _loc1_:Boolean = var_994.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1157 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1157 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               _loc8_.findChildByName("link").procedure = method_15;
