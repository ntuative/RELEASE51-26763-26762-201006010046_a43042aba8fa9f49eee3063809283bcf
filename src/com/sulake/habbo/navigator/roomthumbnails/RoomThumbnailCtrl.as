package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1574,this._model.mode != ThumbnailEditorModel.const_59);
         setEnabled(var_1573,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1574 = IButtonWindow(find("top_tab"));
         var_1573 = IButtonWindow(find("obj_tab"));
         var_2105 = IWindowContainer(find("tile_grid"));
         var_2104 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1574,onTopTabButton);
         Util.setProcDirectly(var_1573,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2105;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2104;
