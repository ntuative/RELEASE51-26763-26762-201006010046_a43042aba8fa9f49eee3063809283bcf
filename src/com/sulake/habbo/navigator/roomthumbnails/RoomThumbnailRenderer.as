package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_785:int = 32;
      
      private static const const_1126:int = 8;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_891.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1127,_loc4_.y + const_1128 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2036[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_891.getImage(ThumbnailEditorModel.const_42,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_891.getImage(ThumbnailEditorModel.const_42,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_891.getImage(ThumbnailEditorModel.const_59,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_785 / 2);
         return new Point(param1 * const_785 + _loc3_,param2 * const_1126);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         {
            var_1076[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1076[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_493)
         {
            if(false)
            {
               refreshObj(param1,var_1076[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1285 == null)
         {
            var_1285 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1285,var_1285.rect,new Point(0,0),null,null,true);
      }
   }
}
