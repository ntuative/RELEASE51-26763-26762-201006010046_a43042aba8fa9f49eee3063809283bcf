package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1202:IButtonWindow;
      ...
      private var var_1201:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_693.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_822.getText());
         addTag(_loc6_,var_820.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1800.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_693.setText(param1.eventDescription);
         var_822.setText(getTagFromEvent(param1,1));
         var_820.setText(getTagFromEvent(param1,2));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1454 = IWindowContainer(find("event_type_disabled_cont"));
            var_1800 = ITextWindow(find("event_type_disabled_text"));
            var_1455 = ITextWindow(find("create_caption"));
            var_1456 = ITextWindow(find("edit_caption"));
            var_1202 = IButtonWindow(find("create_button"));
            var_1200 = IButtonWindow(find("edit_button"));
            var_1799 = IButtonWindow(find("cancel_button"));
            var_1201 = IButtonWindow(find("end_button"));
            var_821 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1202,onCreateButtonClick);
            Util.setProcDirectly(var_1200,onEditButtonClick);
            Util.setProcDirectly(var_1201,onEndButtonClick);
            Util.setProcDirectly(var_1799,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_693 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_822 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_820 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_693.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_693.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_822.goBackToInitialState();
         var_820.goBackToInitialState();
         var_821.selection = 0;
