package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2427:Dictionary;
      ...
      private var var_945:RoomCreateViewCtrl;
      
      private var var_1943:RoomThumbnailRenderer;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_645 = new RoomInfoViewCtrl(this);
         var_945 = new RoomCreateViewCtrl(this);
         var_1943 = new RoomThumbnailRenderer(this);
         var_1018 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_399 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_289.startSearch(Tabs.const_207,Tabs.const_332,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_159.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function showOwnRooms() : void
      {
         ...
         var_289.startSearch(Tabs.const_252,Tabs.const_242);
         var_399.getTab(Tabs.const_252).tabPageDecorator.tabSelected();
      }
