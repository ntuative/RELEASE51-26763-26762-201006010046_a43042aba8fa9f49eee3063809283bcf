package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1943 = new RoomThumbnailRenderer(param1);
         var_838 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_176,var_115.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_838.refreshTags(_loc1_,var_115.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1943.refreshThumbnail(_loc1_,var_115.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_176,var_115);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_176,!true ? getEventCtg(var_115.categoryId) : getRoomCtg(var_115.categoryId));
         refreshRoomDesc(var_176,var_115);
         refreshExtraCont();
         refreshInfo(var_176,"trading_allowed",var_115.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_230,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
