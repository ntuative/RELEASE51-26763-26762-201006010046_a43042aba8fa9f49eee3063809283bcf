package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_553:IDropMenuWindow;
      
      private var var_2429:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_555;
         }
         if(param1 == 3)
         {
            return Tabs.const_534;
         }
         if(param1 == 4)
         {
            return Tabs.const_560;
         }
      ...
      {
         var _loc1_:int = var_553 == null ? 0 : int(var_553.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_553 == null)
         {
            var_553 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_553.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
