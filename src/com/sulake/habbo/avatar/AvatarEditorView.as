package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2302:int = 6710886;
       
      
      private var var_1505:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1059 = [];
         var_1012 = [AvatarEditorFigureCategory.const_733,AvatarEditorFigureCategory.const_48,AvatarEditorFigureCategory.const_215,AvatarEditorFigureCategory.const_572,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_95];
         super();
         var_29 = param1;
         ...
         if(var_1406 == null)
         {
            ...
            var_1406 = var_29.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1635 == null)
         {
            _loc8_ = var_29.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1635 = var_29.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1504 == AvatarEditorSideCategory.const_95 || var_1933))
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_500)
         {
            ...
            var_500 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_500.procedure = stripClubDialogEventProc;
            var_500.center();
         }
         else
         {
            var_500.visible = true;
            var_500.center();
         }
      }
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_499 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_499.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1059.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_499.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_499.numSelectables)
               {
                  var_499.getSelectableAt(_loc6_).x = var_499.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1012);
         }
         if(param1.length != var_1059.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1059.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_489:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_489);
               break;
      ...
      {
         if(var_1504 == AvatarEditorSideCategory.const_95)
         {
            var_1933 = false;
            setSideContent(AvatarEditorSideCategory.const_582);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_268 = param1;
         var_499.setSelected(var_499.getSelectableByName(param1));
         _window.invalidate();
      }
