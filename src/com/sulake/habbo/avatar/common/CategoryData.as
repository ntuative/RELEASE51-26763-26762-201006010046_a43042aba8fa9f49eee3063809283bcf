package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_731 >= 0 && var_177.length > var_731)
         {
            _loc2_ = var_177[var_731];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_177.length > param1)
         {
            _loc3_ = var_177[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_200.length)
         {
            ...
            {
               if(_loc7_.length > var_200[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_200[param2],param2);
         var_200[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_200[param1])
         {
            return null;
         }
      ...
      {
         return var_177[var_731] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_200 = new Array(param1.length);
         var _loc3_:int = 0;
