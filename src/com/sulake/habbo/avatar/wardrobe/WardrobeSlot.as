package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_313 && var_1165)
         {
            _loc5_ = var_29.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_570);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_41,parseInt(FigureData.const_691));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_313 = var_29.figureData.getFigureString();
               var_570 = var_29.gender;
               var_29.handler.saveWardrobeOutfit(var_1439,this);
               updateView();
               break;
            case "get_button":
               if(var_313)
               {
                  var_29.loadAvatarInEditor(var_313,var_570,var_29.clubMemberLevel);
               }
         }
      }
   }
