package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_787:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1128:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_787 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1128 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_787)
         {
            var_787.removeListItems();
         }
         if(var_1128)
         {
            var_1128.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_787)
               {
                  var_787.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1128)
            {
               var_1128.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
