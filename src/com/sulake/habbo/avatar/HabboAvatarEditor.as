package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1093:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1094:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_819:AvatarEditorHandler;
      ...
      private const const_1092:int = 2;
      ...
      private var var_1024:IHabboAvatarEditorDataSaver = null;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_692.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_166)
         {
            ...
            _loc1_ = var_484["null"];
            _loc2_ = var_484["null"];
            _loc1_.loadAvatarData(const_1093,FigureData.const_76);
            _loc2_.loadAvatarData(const_1094,FigureData.const_77);
            var_90 = new Map();
            var_407 = new Map();
            var_90.add(AvatarEditorFigureCategory.const_733,new BodyModel(this));
            var_90.add(AvatarEditorFigureCategory.const_48,new HeadModel(this));
            var_90.add(AvatarEditorFigureCategory.const_215,new TorsoModel(this));
            var_90.add(AvatarEditorFigureCategory.const_572,new LegsModel(this));
            var_90.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_407.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            var_407.add(AvatarEditorSideCategory.const_489,new ClubPromoModel(this));
            var_166 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1024 != null)
         {
            ...
            _loc2_ = "null";
            var_1024.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1452;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1023 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1092)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1635.clone() as IWindowContainer,param1,_loc14_);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1233)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1023 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1406.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_407.getValue(AvatarEditorSideCategory.const_95);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_819 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_692.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_407.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_221 == null)
            {
               var_221 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_733);
         }
         var_1024 = param2;
         return true;
      }
      ...
      {
         var_692 = var_583.getFigureData(AvatarType.const_87);
      }
