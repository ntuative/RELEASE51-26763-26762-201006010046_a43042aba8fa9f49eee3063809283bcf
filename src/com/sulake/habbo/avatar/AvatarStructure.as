package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1619:PartOffsetData;
      ...
      private var var_589:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_775:String;
      
      private var var_1620:AvatarStructureDownloadSet;
      
      private var var_1388:Array;
      
      private var var_776:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_184 = param2;
         var_947 = param3;
         var_325 = new FigureData();
         var_451 = new PartSetsData();
         var_589 = new AnimationData();
         var_1620 = new AvatarStructureDownloadSet();
         var_776 = new AnimationManager();
         var_775 = param4;
         var_1619 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_946.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_946.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_325.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_946.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_776.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_451.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_451.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1400[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_946.getDefaultAction();
         var _loc9_:Array = var_451.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_776.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_325.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_325.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_589.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_451.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_451.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_775 + " ready to go!");
         if(var_775 == AvatarType.const_87)
         {
            var_451.getPartDefinition("ri").appendToFigure = true;
            var_451.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_775)
         {
            case AvatarType.const_87:
               ...
               var_1620.add(new AvatarStructureDownload(var_184,_loc5_,var_325));
               break;
            case AvatarType.PET:
         }
         var_1620.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_776.getAnimation(param1);
      }
      ...
      {
         var_946 = new AvatarActionManager(var_184,var_775);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1388 = var_325.getMandatorySetTypeIds();
         return var_1388;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_325.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_947.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_947.getAssetByName("dance" + _loc1_).content as XML;
            var_776.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_947.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_947.getAssetByName("fx" + _loc1_).content as XML;
            var_776.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_325.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_325.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1619.loadOffsets(var_947);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_946.sortActions(param1);
      }
   }
}
