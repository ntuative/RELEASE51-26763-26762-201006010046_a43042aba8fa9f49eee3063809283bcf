package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1470:int = 60000;
      ...
      {
         if(var_624 == param1 || var_624 == GeometryType.const_822 && param1 == GeometryType.const_1016 || param1 == GeometryType.const_822 && var_624 == GeometryType.const_1016)
         {
            var_624 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_573)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_487)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_52.getParts(param1,(var_805 as AvatarImage).getFigure(),_loc6_,var_624,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_52.getCanvas(var_148,var_624);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1206[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc29_ == AvatarAction.const_962 || _loc29_ == AvatarAction.const_653) && (_loc6_ == AvatarBodyPartType.const_215 || _loc6_ == AvatarBodyPartType.const_1245 || _loc6_ == AvatarBodyPartType.const_1209) && _loc7_.color != null)
               {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_140 != null)
         {
            ...
            {
               _loc5_ = var_140.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
