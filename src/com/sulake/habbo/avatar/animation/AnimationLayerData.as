package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_573:String = "bodypart";
      
      public static const const_487:String = "fx";
      ...
      private var var_1429:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_1665 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1350 = parseInt(param2.@dy);
         var_1351 = parseInt(param2.@dz);
         var_1320 = parseInt(param2.@dd);
         _type = param3;
         ...
         if(param5 != null)
         {
            var_1429 = new ActiveActionData(param5.state,_loc7_);
            var_1429.definition = param5;
         }
      }
