package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2139:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         var_1531 = parseInt(param2.@ink);
         var_2140 = String(param2.@member);
         var_2141 = Boolean(parseInt(param2.@directions));
         _dx = [];
         var_1350 = [];
         var_1351 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            var_1350[_loc4_] = parseInt(_loc3_.@dy);
      ...
      {
         if(param1 < var_1350.length)
         {
            return var_1350[param1];
         }
         return 0;
      }
