package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1542:Number = 1.0;
      ...
      private var var_2034:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1539,var_1542,var_1538,_alphaMultiplier);
         var_1073 = generatePaletteMapForGrayscale(var_2033,var_2032);
      }
      
      public function get reds() : Array
      {
         return var_1073.getValue("reds") as Array;
      }
      ...
      {
         return var_1073.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1073.getValue("greens") as Array;
      }
      ...
      {
         return var_1073.getValue("alphas") as Array;
      }
