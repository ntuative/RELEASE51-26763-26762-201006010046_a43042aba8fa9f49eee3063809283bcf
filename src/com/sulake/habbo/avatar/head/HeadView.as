   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_150,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_181,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_191,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_175,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_184,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_149 == "")
         {
            _model.switchCategory(FigureData.const_150);
         }
      }
