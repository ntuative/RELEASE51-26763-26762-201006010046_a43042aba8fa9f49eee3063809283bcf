package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_865:String = "AVATAR_STRUCTURE_DONE";
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1584 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2152.appendXML(var_1584);
         dispatchEvent(new Event(AvatarStructureDownload.const_865));
      }
   }
}
