package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private const const_1715:int = 0;
      
      private var var_141:AvatarRenderManager;
      
      private const const_362:int = 2;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               var_478.add(_loc4_,new PetData(_loc3_));
            }
         }
      }
      ...
      private function notifyListeners() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_681.pop() as IPetDataListener;
            if(_loc1_ != null)
            {
               _loc1_.petDataReady();
            }
      ...
      {
         var _loc4_:PetData = var_478.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      {
         var _loc3_:IPetData = var_478.getValue(param1) as IPetData;
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_478.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_478.getValue(key);
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.var_2128.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
