package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1327:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1327:
               if(var_159 != null)
               {
                  _loc5_ = var_159.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1000:
               if(var_159 != null)
               {
                  if(var_159 != null)
                  {
                     _loc5_ = var_159.getKey("group.badge.url");
