package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1291 && param1.type == RoomEngineObjectEvent.const_244)
         {
            var_29.showView();
            var_1291 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1291 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_301,_loc3_.figure);
            var_29.closeView();
            return;
         }
      ...
      {
         if(var_1077.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
