package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_808:uint = 4284532064;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_180)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1025)
            {
            ...
            var_375.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_424);
            var_375.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_183)
            {
               var_183.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_183.stop();
               var_183 = null;
            }
            if(var_375 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1613 == null)
         {
            var_1613 = createMinimizedWindow();
         }
         if(!var_2257)
         {
            return var_66;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_183 == null)
         {
            var_183 = new Timer(1000,3);
            var_183.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_183.reset();
         var_183.repeatCount = 3;
         var_183.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_808) : uint(const_809);
            }
