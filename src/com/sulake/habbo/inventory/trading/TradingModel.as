package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_287:uint = 3;
      
      public static const const_193:uint = 1;
      
      public static const const_187:uint = 0;
      
      public static const const_1222:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_501 = false;
         var_715 = false;
         var_48.updateItemList(var_716);
         var_48.updateItemList(var_1248);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_48.alertPopup(TradingView.const_838);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_716)
            {
               var_501 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_715 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_716)
            {
               var_48.alertPopup(TradingView.const_1012);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_35 + " NEW STATE: " + param1 + " OWN: " + var_501 + " OTHER: " + var_715);
         ...
         {
            case const_187:
               if(param1 == const_193 || param1 == const_241)
               {
                  var_35 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_48.setMinimized(param1 != InventoryCategory.const_80);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_180)
            {
      ...
      public function close() : void
      {
         if(var_636)
         {
            if(var_35 != const_187 && var_35 != const_241)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_187;
            var_11.toggleInventorySubPage(InventorySubCategory.const_988);
            var_636 = false;
         }
         var_48.setMinimized(false);
      }
