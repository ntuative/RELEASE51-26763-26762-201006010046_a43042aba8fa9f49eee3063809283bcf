package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_773:MarketplaceModel;
         ...
         else if(param1.type == WindowEvent.const_64)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_355);
            }
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_520.getValue(var_519);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_295)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_180)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_773 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
