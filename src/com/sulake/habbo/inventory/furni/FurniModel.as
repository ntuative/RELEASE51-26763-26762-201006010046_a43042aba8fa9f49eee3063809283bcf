package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_355:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_244,onObjectPlaced);
         var_481 = new Timer(const_1081,1);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_261;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_655)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_244,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_180)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_295)
         {
         ...
         if(var_690 == null)
         {
            var_690 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_690.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_261:
               ...
               break;
            case InventorySubCategory.const_988:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_318);
      ...
      {
         if(var_816 && param1.type == RoomEngineObjectEvent.const_244)
         {
            var_29.showView();
            var_816 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_343 || _loc3_.category == FurniCategory.const_354 || _loc3_.category == FurniCategory.const_295)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_404 = new Map();
         var_404.add(const_45,new Array());
         var_404.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
