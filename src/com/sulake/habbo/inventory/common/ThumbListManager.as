package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_585 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_585.width;
         var_95 = var_585.height;
         var_1038 = param5;
         var_834 = param6;
         var_223 = Math.floor(var_1038 / _thumbWidth);
         var_18 = new BitmapData(var_1038,var_834);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_18.height < var_834)
         {
            _loc12_ = new BitmapData(var_18.width,var_834);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_585.width,var_585.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_585.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_585,var_585.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var_18 = new BitmapData(Math.max(var_223 * _thumbWidth,var_1038),Math.max(var_491 * var_95,var_834),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_223 && var_18.height < _loc3_.y * var_95)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_223 - 1),var_95);
         ...
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_223 - 1),0 - var_95);
