package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_659);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_180)
            {
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_318))
         {
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.removeBadge(_loc2_.method_7);
         }
         var _loc4_:AchievementsModel = var_11.achievementsModel;
         if(_loc4_ != null)
         {
            _loc4_.removeAchievement(_loc2_.method_7,_loc2_.level);
         }
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_11.setInventoryCategoryInit(InventoryCategory.const_356);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Array = _loc2_.method_10();
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ == null)
         {
            return;
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_261);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_281);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_318);
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
