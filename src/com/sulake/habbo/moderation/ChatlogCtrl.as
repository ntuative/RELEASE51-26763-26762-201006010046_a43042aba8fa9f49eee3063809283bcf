package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_919 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_918 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_919.clone());
      ...
      {
         if(param1.type != WindowEvent.const_47 || param2 != var_54)
         {
            return;
         }
