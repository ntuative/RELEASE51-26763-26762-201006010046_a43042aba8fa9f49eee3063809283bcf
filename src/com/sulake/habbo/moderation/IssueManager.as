package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_964:String = "issue_bundle_open";
      
      public static const const_714:String = "issue_bundle_my";
      
      public static const const_953:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_136 = new Map();
         var_863 = new Map();
         var_611 = new IssueBrowser(this,var_63.windowManager,var_63.assets);
         var_720 = [];
         var_862 = [];
         var_1063 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1063.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_720 = var_720.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_863.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_863.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1326)
         {
            var_152.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_136)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_863.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_863.add(param1.issueId,_loc2_);
         ...
         if(var_720.indexOf(param1.issueId) != -1)
         {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1063.remove(param1);
         var_1063.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_1063.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_63.soundManager.playSound(HabboSoundTypesEnum.const_839);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_863.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_136.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
