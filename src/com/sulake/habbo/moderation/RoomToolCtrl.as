package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_686,_data.flatId),var_54,false,false,true);
      }
      ...
      private function method_11(param1:Array) : String
      {
         var _loc3_:* = null;
         var _loc2_:String = "";
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         _loc8_.text = method_11(param1.tags);
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_406);
         if(param1.flatId != var_406)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_406);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_694.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1174,_loc2_,var_415.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1026.isSelected,var_1027.isSelected,var_694.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1356);
         }
      ...
      public function populate() : void
      {
         ...
         var_694 = ICheckBoxWindow(var_54.findChildByName("kick_check"));
         var_1026 = ICheckBoxWindow(var_54.findChildByName("lock_check"));
         var_1027 = ICheckBoxWindow(var_54.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_406));
         Logger.log("BEGINNING TO SHOW: " + var_406);
      }
   }
}
