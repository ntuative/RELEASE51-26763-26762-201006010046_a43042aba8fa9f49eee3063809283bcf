package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_1117 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         ...
         if(false)
         {
            var_1117.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_1024,_loc2_),_window,false,false,true);
      }
      ...
      {
         return WindowTracker.const_1415;
      }
   }
}
