package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_886:String = "ROSM_SOUND_MACHINE_SWITCHED_ON";
      
      public static const const_1359:String = "ROSM_JUKEBOX_INIT";
      
      public static const const_1298:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
