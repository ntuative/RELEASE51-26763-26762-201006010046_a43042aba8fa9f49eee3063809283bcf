package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_950);
      ...
      {
         if(param1 < var_652.length)
         {
            return var_652[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_245 != null)
         {
            ...
            {
               _loc2_ = var_245[_loc3_];
               _loc2_.update(var_652,var_2285,param1);
               _loc3_++;
            }
