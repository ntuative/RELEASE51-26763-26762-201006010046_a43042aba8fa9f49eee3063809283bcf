   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1784)
         {
            if(!param1)
            {
               var_252.assign(var_579);
               var_253.assign(var_580);
            }
            else
            {
               var_252.assign(var_579);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_72 == null && var_797 != null || var_252 == null || var_253 == null || var_467 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1191)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1015 || _loc4_.y != var_1702 || _loc4_.z != var_1703 || param1.scale != var_1704))
            {
               var_1015 = _loc4_.x;
               var_1702 = _loc4_.y;
               var_1703 = _loc4_.z;
