package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1270:int = 360;
      
      private var var_1997:int = 0;
      
      private var var_728:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1270 / 2) % 360 / var_1270;
         ...
         {
            _loc6_ = int(var_231.getKey(_loc5_)) * var_1270;
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_975);
                  break;
               case "DARKEN":
