package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var _loc3_:Number = var_1238 * Math.cos(var_896 + var_1535);
         var _loc4_:Number = var_1238 * Math.sin(var_896 + var_1535);
         var _loc5_:Number = _height;
         var_741.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_741.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_741.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_741.add(param1);
         }
