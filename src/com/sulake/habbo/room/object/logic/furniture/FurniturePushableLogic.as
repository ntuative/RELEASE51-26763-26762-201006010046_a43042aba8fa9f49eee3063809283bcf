   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_1045 / _loc3_.state;
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1532.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1532).length > 0)
            {
               if(object.getState(0) != const_786)
               {
                  object.setState(const_786,0);
               }
            }
            else
            {
