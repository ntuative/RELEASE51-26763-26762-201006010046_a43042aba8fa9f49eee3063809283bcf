package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_431:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_405,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_464,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_384,onTaskDoneEvent);
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_217 || var_33.id == const_92))
         {
            showView(const_92);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1484;
         _window.width = _loc2_.width + var_1485;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_655)
         {
            showView(const_217);
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_405,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_464,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_384,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_405:
               var_990 = true;
               if(var_33 != null && var_33.id == const_431)
               {
                  showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_464:
               if(var_33 != null && var_33.id == const_340)
               {
                  var_1156 = true;
                  disposeWindow();
               }
      ...
      {
         var_988 = true;
         if(var_33 != null && (var_33.id == const_340 || var_33.id == const_92))
         {
            showView(const_92);
         }
      }
      ...
      {
         return var_988 && var_989 && var_990;
      }
   }
}
