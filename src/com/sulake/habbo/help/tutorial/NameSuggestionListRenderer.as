package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1732:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_927 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_927 += param1.height + const_1733;
            return fit(param1);
         }
         param1.offset(_offsetX,var_927);
         _offsetX += param1.width + const_1732;
         return true;
      }
