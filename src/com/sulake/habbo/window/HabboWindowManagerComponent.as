package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1142:uint = 1;
      ...
      private var var_1355:IEventDispatcher;
      
      private var var_2422:uint = 0;
      
      private var var_1356:ProfilerAgentTask;
      
      private var var_1354:ProfilerOutput;
      
      private var var_756:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1355 = Component(param1).events;
         var_438 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_713 = new SkinContainer(_loc3_.content as XML,assets);
         var_756 = new WindowRenderer(var_713);
         var_243 = new Array(const_365);
         var _loc5_:int = 0;
         while(_loc5_ < const_365)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_756,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_243[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_221 = var_243[const_1142];
         ...
         var_221.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1379,_loc6_);
      }
      ...
      {
         return var_243[param1].getDesktopWindow().getChildAt(var_221.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_438[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_438[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1354 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1354 = new ProfilerOutput(_loc3_,this,var_756);
               var_1357 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1357);
               var_1356 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1356);
               var_1101 = true;
            }
         }
      }
      ...
      {
         return var_713.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_965.length > 0)
         {
            var_1355.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_365 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1355.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_965.length > 0)
         {
            WindowContext.var_965.flush();
         }
         if(WindowContext.var_1405.length > 0)
         {
            WindowContext.var_1405.flush();
         }
         var_1355.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1175,param2.name + ": " + param2.toString());
            }
         }
      }
   }
