package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1464:String = "no_reqs_info";
      ...
      private var var_1497:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_344 && _loc4_.state != FriendRequest.const_326)
            {
      ...
      {
         var_1496 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1497 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1497.procedure = onDismissAllButtonClick;
         var_1496.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_344 && _loc4_.state != FriendRequest.const_326)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_283,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1034)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1496,_loc1_);
         setEnabled(var_1497,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_283,param1));
         }
      }
   }
}
