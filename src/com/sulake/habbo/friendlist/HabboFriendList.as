package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1631:OpenedToWebPopup;
      
      private var var_857:IAvatarRenderManager;
      ...
      private var var_1630:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_654:ISessionDataManager;
      
      private var var_378:FriendRequests;
      
      private var var_1754:int;
      
      var var_90:FriendCategories;
      
      private var var_2297:FriendListLookAndFeel;
      ...
      {
         var_2297 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_90 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1630 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_378.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_378.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_399.findTab(FriendListTab.const_91).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_654 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_378 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_90.addCategory(new FriendCategory(FriendCategory.const_841,getText("friendlist.friends")));
         var_90.addCategory(new FriendCategory(FriendCategory.const_390,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_90.addFriend(new Friend(_loc4_));
         }
         var_399 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_552)
         {
            var_552 = new Timer(120000);
            var_552.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_552.start();
         }
         getBuddyRequests();
         registerListeners();
      ...
      override public function dispose() : void
      {
         ...
         {
            var_552.stop();
            var_552.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_552 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_857)
         {
            var_857.release(new IIDAvatarRenderManager());
            var_857 = null;
         }
         if(var_959)
         {
            var_959.release(new IIDHabboNotifications());
            var_959 = null;
         }
         if(var_189)
         {
         ...
         if(var_654)
         {
            var_654.release(new IIDSessionDataManager());
            var_654 = null;
         }
         super.dispose();
      }
      ...
      {
         var_90.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_159.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_399.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_345));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1630.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_176,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_378.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_90.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_654.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_654.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_378.limit)
         {
            var_378.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_399.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_857.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_378.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_399.findTab(FriendListTab.const_91);
      ...
      {
         return var_159.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1631 == null)
         {
            var_1631 = new OpenedToWebPopup(this);
         }
         var_1631.show(x,y);
      }
