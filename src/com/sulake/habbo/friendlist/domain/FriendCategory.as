package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_346:int = 100;
      ...
      {
         return Math.ceil(this.var_238.length / const_346);
      }
      ...
      {
         if(this.var_905 >= this.getPageCount())
         {
            this.var_905 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_905 + 1) * const_346,this.var_238.length);
      }
