package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1671:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_570 = param1.gender;
         var_750 = param1.online;
         var_1251 = param1.followingAllowed && param1.online;
         var_313 = param1.figure;
         var_1286 = param1.motto;
         var_1288 = param1.lastAccess;
         var_1269 = param1.categoryId;
         var_1287 = param1.realName;
