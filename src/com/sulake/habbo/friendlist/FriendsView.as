package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_758:String = "bg";
      ...
      {
         var_1827 = method_3("open_minimail",onMinimailButtonClick,param1);
         var_1825 = method_3("open_homepage",onHomeButtonClick,param1);
         var_1824 = method_3("room_invite",onInviteButtonClick,param1);
         var_1826 = method_3("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_758);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1827,isEnableMinimailButton(_loc1_));
         setEnabled(var_1825,isEnableHomeButton(_loc1_));
         setEnabled(var_1824,isEnableInviteButton(_loc1_));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_758);
