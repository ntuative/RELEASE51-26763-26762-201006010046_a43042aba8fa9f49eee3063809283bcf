package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_836:IWindow;
      
      private var var_835:IWindow;
      
      private var var_448:Number;
      ...
      {
         super();
         var_183 = new Timer(1000);
         var_183.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_835 = _window.findChildByName("effect_hilite");
            var_835.visible = false;
         }
         var_837 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_836 = _window.findChildByName("loader_bar");
         if(var_836 != null)
         {
            var_448 = var_836.width;
            var_183.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_183.stop();
            var_183.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_183 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_837 != null)
         {
            var_837.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_837.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
