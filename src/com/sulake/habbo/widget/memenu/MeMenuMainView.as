      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_830);
               break;
            case "wave":
               if(false)
               {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_591);
               break;
            case "rooms":
            ...
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_873));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_599);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","com.sulake.habbo.communication.messages.outgoing.avatar") == "true";
               if(false && _loc4_)
               {
