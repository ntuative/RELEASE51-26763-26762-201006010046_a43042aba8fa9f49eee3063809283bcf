package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1743:uint = 4.282169599E9;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1600);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_768)
         {
            return;
         }
         if(var_768 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_768) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_768 % 2) ? uint(const_1474) : uint(const_1475);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1743;
            var_768 = param1;
         }
      }
