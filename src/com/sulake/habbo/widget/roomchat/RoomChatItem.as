package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1167:Number = 18;
      
      private static const const_1478:Number = 10;
      
      private static const const_1479:Number = 8;
      ...
      private var var_211:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1124,var_1125,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1124,var_785,var_1125,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1398 = param1.chatType;
         var_1124 = param1.userId;
         var_785 = param1.userName;
         var_1125 = param1.userCategory;
         _message = param1.text;
         var_1399 = param1.userX;
         var_211 = param1.userImage;
         var_1126 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1398)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_290:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_289:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_211 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_211.height);
         }
         ...
         if(var_211 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_211.width;
               _loc28_.height = var_211.height;
               _loc28_.bitmap = new BitmapData(var_211.width,var_211.height,true,0);
               _loc28_.bitmap.copyPixels(var_211,var_211.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_455 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_211.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1126 != 0)
            {
               _loc30_ = uint(var_1126 >> 16 & 255);
               _loc31_ = uint(var_1126 >> 8 & 255);
               _loc32_ = uint(var_1126 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1398 == RoomWidgetChatUpdateEvent.const_290)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_785);
            }
            else if(var_1398 == RoomWidgetChatUpdateEvent.const_289)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_785);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_370 + _loc20_.textWidth + const_518;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1124,var_1125,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1124,var_1125,_roomId,_roomCategory,param1);
      }
