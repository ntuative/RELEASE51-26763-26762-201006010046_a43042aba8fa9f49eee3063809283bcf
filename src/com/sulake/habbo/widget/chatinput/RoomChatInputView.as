package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_448:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1651 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1650 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_669 = new Timer(1000,1);
         var_669.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_793 = new Timer(5000,1);
         var_793.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_57,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1652 = _loc2_.width + const_518 + _loc6_.width + const_1060;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1059,_loc8_.width) + const_518);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_448);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_448);
         }
