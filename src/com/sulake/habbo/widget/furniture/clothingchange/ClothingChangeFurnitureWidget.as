package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_782:String = "Girl";
      
      private static const const_781:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_304,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_828,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_304:
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1797 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_57,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_304,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_828,onUpdate);
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_616 = _loc4_;
         var_616.offset(100,100);
         var _loc6_:IWindow = var_616.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_306,param1,var_154,var_1797,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_616 != null)
         {
            _loc1_ = var_616 as IFrameWindow;
            if(_loc1_ != null)
            {
