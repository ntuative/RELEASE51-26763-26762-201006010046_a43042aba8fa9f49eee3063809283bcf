package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_419:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_419.destroyGridItems();
         var_307 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1263) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_872.width,var_872.height,true,0);
      ...
      {
         var _loc2_:int = var_419.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_419.numGridItems)
         {
            return;
         }
         select(var_419.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_872 = BitmapData(_loc3_.content);
