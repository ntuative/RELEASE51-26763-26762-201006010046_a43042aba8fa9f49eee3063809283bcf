package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1461:String = "infostand_user_view";
      ...
      private var var_848:InfoStandFurniView;
      
      private var var_404:InfostandFurniData;
      
      private var var_348:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1462:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1459:String = "infostand_pet_view";
      
      private const const_1460:String = "infostand_furni_view";
      
      private const const_1723:int = 3000;
      
      private var var_198:InfoStandUserView;
      
      private var var_427:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_848 = new InfoStandFurniView(this,const_1460);
         var_198 = new InfoStandUserView(this,const_1461);
         var_304 = new InfoStandPetView(this,const_1459);
         var_348 = new InfoStandBotView(this,const_1462);
         var_427 = new InfostandUserData();
         var_404 = new InfostandFurniData();
         var_1215 = new InfoStandPetData();
         var_132 = new Timer(const_1723);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_198.setTags(param1.tags,var_1894);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_276,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_129,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_748,onFurniInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_374,var_304.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_276,onRoomObjectRemoved);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_129,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_748,onFurniInfo);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_348.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_129:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_276:
               if(var_198 != null && false && var_198.window.visible)
               {
                  _loc2_ = param1.id == var_427.userRoomId;
                  break;
               }
               ...
               if(var_348 != null && false && var_348.window.visible)
               {
                  _loc2_ = param1.id == var_427.userRoomId;
                  break;
               }
