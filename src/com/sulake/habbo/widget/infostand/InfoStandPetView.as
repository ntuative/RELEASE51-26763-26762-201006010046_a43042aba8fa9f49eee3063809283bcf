package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1740:String = "level";
      
      private var var_106:IItemListWindow;
      
      private const const_1738:String = "energy";
      
      private var var_1215:Map;
      
      private const const_1734:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1736:uint = 3355443;
      
      private var var_225:IBorderWindow;
      
      private const const_1737:int = 158;
      
      private const const_1741:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_181:PetCommandTool;
      
      private const const_1742:uint = 11184810;
      
      private const const_1739:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_225 != null)
         {
            var_106 = var_225.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_106 == null || var_225 == null || var_64 == null)
         {
            return;
         }
         ...
         var_225.height = NaN;
         _window.width = Math.max(var_225.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1215.getValue(var_584) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_181.method_5(true);
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1740,param1.level,param1.levelMax);
         updateStateElement(const_1739,param1.experience,param1.experienceMax);
         updateStateElement(const_1738,param1.energy,param1.energyMax);
         updateStateElement(const_1734,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_584 = param1.id;
         var_1215.remove(param1.id);
         var_1215.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_181 && var_181.getPetId() == var_584)
               {
                  var_181.method_5(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_371,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1737,const_1741,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1742);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1736);
