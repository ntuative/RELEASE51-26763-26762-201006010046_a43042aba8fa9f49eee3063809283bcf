package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1728:int = 40;
      
      private var var_508:IWindowContainer;
      
      private const const_1452:int = 2;
      ...
      private function updateList() : void
      {
         ...
         if(!var_508)
         {
            ...
            var_508 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_508)
         {
            return;
         ...
         updateStatusDisplay(const_1452,_loc2_.length);
         if(!var_421)
         {
            var_421 = new Timer(25);
            var_421.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_880 = 0;
         populateList();
         var_421.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_615)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_508 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_508.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1453);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_420.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_421)
         {
            var_421.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_421 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_880 >= var_615.length)
            {
               return true;
            }
            addListItem(var_615.getWithIndex(var_880));
            ++var_880;
            _loc1_++;
         }
         return false;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_420));
            _loc7_.selection = 0;
         }
      }
