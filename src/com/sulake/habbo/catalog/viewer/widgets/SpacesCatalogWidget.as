package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_115:String = "landscape";
      ...
      private var var_1239:String = "MeMenuWidgetHandler";
      ...
      private var _floorType:String = "MeMenuWidgetHandler";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_159.floors.pattern)
                     {
                     ...
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_159.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_159.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_275 != null && var_277 != null)
         {
            setRoomImage(var_275,var_277);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_159.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_230 >= 0)
         ...
         for each(_loc1_ in var_159.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_159.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_201:
               ...
               var_725 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_159.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
            ...
            case const_200:
               ...
               if(var_309 >= _activeFloorPatterns.length)
               {
                  var_309 = 0;
               }
               var_276 = 0;
               ...
               for each(_loc9_ in var_159.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_727 = _loc9_.children().length();
                  }
               }
            ...
            case const_115:
               ...
               var_726 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_159.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_landscape_pattern_next":
               changePattern(const_115,-1);
               break;
            case "ctlg_landscape_pattern_prev":
               changePattern(const_115,1);
               break;
            case "ctlg_landscape_color_prev":
               changeColor(const_115,-1);
               break;
            case "ctlg_landscape_color_next":
               changeColor(const_115,1);
               break;
            case "ctlg_buy_landscape":
               _loc3_ = var_1268[var_310];
               if(_loc3_ != null)
               {
