package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1313.text = "${" + _loc3_.name + "}";
            var_1312.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1313.text = "${" + _loc2_.localizationId + "}";
            var_1312.text = "${" + _loc2_.localizationId + "}";
         }
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_455:
                  ...
                  if(var_637 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_637,var_1371,var_1257);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_243:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_321,AvatarAction.const_689);
                              _loc13_.appendAction(AvatarAction.const_709,_loc6_.productClassId);
      ...
      {
         var_1313 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1312 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1597 = new Point(var_86.x,var_86.y);
         var_637 = _window.findChildByName("bundleGrid") as IItemGridWindow;
