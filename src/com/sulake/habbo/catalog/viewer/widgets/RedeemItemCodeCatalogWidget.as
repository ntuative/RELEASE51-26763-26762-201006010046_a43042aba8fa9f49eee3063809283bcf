package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1051:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1051 != null)
         {
            var_1051.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1050 != null)
         {
            var_1050.removeEventListener(WindowKeyboardEvent.const_153,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1051 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1051 != null)
         {
            var_1051.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1050 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1050 != null)
         {
            var_1050.addEventListener(WindowKeyboardEvent.const_153,windowKeyEventProcessor);
         }
      }
