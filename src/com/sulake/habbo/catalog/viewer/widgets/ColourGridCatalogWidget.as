package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1216 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_307 = null;
         for each(_loc1_ in var_1217)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1216) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_702.width,var_702.height,true,0);
               _loc3_.bitmap.copyPixels(var_702,var_702.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_876.width,var_876.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_730.width,var_730.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_730,var_730.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_730 = _loc4_.content as BitmapData;
         populateColourGrid();
