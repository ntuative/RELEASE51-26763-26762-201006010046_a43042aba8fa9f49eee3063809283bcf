package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1722:uint = 4.291613146E9;
      ...
      private const const_1721:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_840;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_840,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_388,var_80,var_1041);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_840);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_588[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_587[var_196]);
         _catalog.purchaseProductAsGift(var_388,var_80,var_1041,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_119:
               ...
               if(var_1861 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_238)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1721)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1861 = _loc3_.text;
               break;
            case WindowMouseEvent.const_54:
               showSuggestions(false);
               if(var_1223)
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1477 = _loc1_.stuffTypes;
            var_588 = _loc1_.boxTypes;
            var_587 = _loc1_.ribbonTypes;
            var_840 = var_1477[0];
            _boxIndex = var_588[0];
            var_196 = var_587[0];
            initColorGrid();
