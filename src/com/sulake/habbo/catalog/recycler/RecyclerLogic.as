package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_784:int = 0;
      
      public static const const_177:int = 5;
      
      private static const const_362:int = 1;
      
      private static const const_783:int = 2;
      ...
      private function updateRecyclerButton() : void
      {
         ...
         _view.updateRecycleButton(method_8());
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1530)
         {
            case RecyclerStatusMessageEvent.const_1194:
               var_280 = const_362;
               if(_view == null)
               {
                  return;
      ...
      {
         return var_1530 != RecyclerStatusMessageEvent.const_985;
      }
      
      private function get statusActive() : Boolean
      {
         return var_280 != const_784;
      }
      ...
      {
         return active && var_280 == const_362;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_889:
               if(_view != null)
               {
      ...
      public function method_8() : Boolean
      {
         if(!ready || true)
         {
            return false;
