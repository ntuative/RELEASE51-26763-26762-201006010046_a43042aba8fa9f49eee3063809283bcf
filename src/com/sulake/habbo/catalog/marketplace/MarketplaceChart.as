package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_993 + var_993 / -var_2388 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_800 - var_800 / var_395 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         var_800 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_800);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_800 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_993,(param2 - var_800) / 2));
         return _loc3_;
      }
