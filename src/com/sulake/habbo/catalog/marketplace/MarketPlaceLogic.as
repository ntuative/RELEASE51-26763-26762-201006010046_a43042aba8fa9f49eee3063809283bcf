package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1748:int = 3;
      
      public const const_1483:int = 2;
      ...
      private var var_2157:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1653,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2155 || param1.furniTypeId != var_2159)
         {
            return;
         }
         var_2157 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_207.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1483,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_207.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_207.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_501)
            {
               var_207.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2150 = _loc3_.creditsWaiting;
         var_207 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_207.add(_loc4_.offerId,_loc6_);
         }
      ...
      {
         requestOffers(var_2154,var_2158,var_2156,var_2153);
      }
