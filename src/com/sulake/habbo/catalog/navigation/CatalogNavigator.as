package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2393:String = "catalog.page.club";
      
      private var var_2413:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","com.sulake.habbo.communication.messages.outgoing.avatar") == "true";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2393,true);
      }
