package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_111:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_626,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_606];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_606:
      ...
      {
         return [RoomSessionDoorbellEvent.const_111,RoomSessionDoorbellEvent.const_127,RoomSessionDoorbellEvent.const_58];
      }
