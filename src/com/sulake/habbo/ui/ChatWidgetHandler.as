package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_854:Number = 0.0;
      ...
      public function dispose() : void
      {
         ...
         if(var_351 != null)
         {
            ...
            {
               _loc2_ = var_351.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_351.getValue(_loc15_) as BitmapData;
      ...
      {
         return [RoomWidgetChatMessage.const_641,RoomWidgetChatSelectAvatarMessage.const_682];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_641:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_151,_container.roomSession,0,"Version 26763-26762-201006010037");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_682:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_854 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_854);
            }
            if(var_497 == null)
            {
               var_498.x = 0;
               var_498.y = 0;
               var_498.z = 0;
               var_497 = _loc4_.getScreenPoint(var_498);
               var_854 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_498.x = 0;
