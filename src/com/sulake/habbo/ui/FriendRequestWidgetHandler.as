package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_526);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_624);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_645);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_283:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_526:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_624:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_645:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_283);
         return _loc1_;
      }
