package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_694,RoomWidgetEcotronBoxOpenMessage.const_587,RoomWidgetEcotronBoxOpenedMessage.const_1253];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_694:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_587:
