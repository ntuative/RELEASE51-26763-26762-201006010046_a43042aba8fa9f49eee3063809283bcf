package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1720:String = "room_widget";
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_56.getChildByTag(const_1100) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_56.findChildByTag(const_1100) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_703;
               _loc2_.width = var_56.desktop.width - var_703;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_703;
               _loc2_.height = var_56.desktop.height - var_703;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_56.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_56.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_266,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1720) == 0)
            {
