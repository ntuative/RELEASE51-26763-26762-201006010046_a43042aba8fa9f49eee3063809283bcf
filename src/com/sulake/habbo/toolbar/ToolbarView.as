package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_202 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_1035,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1086 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1086)
         {
         ...
         var_1302 = _loc7_.toolbar.@margin_bottom;
         ...
         createGroupsFromXmlList(_loc8_,var_282,param1,param2,_window,var_290);
         createGroupsFromXmlList(_loc9_,var_623,param1,param2,var_202,var_290);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_139,var_515,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1543,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1302) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1543,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1302) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_.method_4 = _loc7_.@window_margin;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_139,var_515);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_139,var_515);
         }
      }
