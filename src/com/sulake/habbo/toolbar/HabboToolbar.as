package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_176,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_52,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_457,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_712,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_941,onHideWindowEvent);
         var_35 = true;
