package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1152:Number = 90;
      
      private static const const_791:int = 50;
      
      private static const const_1144:Number = 25;
      
      private static const const_1143:int = 50;
      
      private static const const_202:Boolean = true;
       
      
      private var var_632:Timer;
      
      private var var_1102:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1102 = param2;
         var_632 = new Timer(const_1144);
         var_632.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1102.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_316.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_316.splice(var_316.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1102.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_631[_loc3_] = new Array();
            }
            if(var_631[_loc3_].indexOf(param1) < 0)
            {
               var_631[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_791 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_791 || param1.desktop.height - param1.y < const_1143;
      }
      
      public function method_6(param1:String, param2:Boolean) : void
      {
         var _loc3_:MenuAnimatorItem = getItemObject(param1);
         if(_loc3_ == null)
         {
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_527.length)
         {
            if(var_527[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_631[_loc3_].length)
                  {
                     method_6(var_631[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         _toolbarSize = param5;
         param3.visible = true;
         if(!windowShouldAnimate(param3,param5,param1.method_4,param6))
         {
