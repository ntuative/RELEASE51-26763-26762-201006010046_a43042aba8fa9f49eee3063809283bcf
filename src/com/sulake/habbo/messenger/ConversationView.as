package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1145:int = 20;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_137 = param1;
         var_1582 = method_3("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2146 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_137.refreshButton(param2,"close",true,onCloseButtonClick,0);
         method_3("minimail",onMinimailButtonClick,param2);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_524 || param3.type == Message.const_729 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_529.messages.length - const_792);
         _loc1_ = 0;
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_792 + const_1145)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_137.send(new FollowFriendMessageComposer(var_529.id));
      }
      ...
      private function method_3(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1146;
         param1.invalidate();
      }
   }
}
