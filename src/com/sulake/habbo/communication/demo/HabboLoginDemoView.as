package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_742:String = "InitConnection";
       
      
      private const const_1456:String = "fuselogin";
      
      public var name:String = "";
      
      private var _window:IWindowContainer;
      
      private var var_172:HabboCommunicationDemo;
      ...
      {
         var_172.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_172.shockwaveClientUrl = var_113.shockwaveClientUrl;
         var_172.ssoTicket = var_113.ticket;
         var_113.removeEventListener(SSOTicket.const_353,onParsedTicketSuccess);
         var_113.removeEventListener(SSOTicket.const_279,onParsedTicketFailure);
         var_113 = null;
         dispatchEvent(new Event(const_742));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1456,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_172 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_172.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_406,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_172.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1456,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_172.habboConfiguration.getKey("use.sso","com.sulake.habbo.communication.messages.outgoing.avatar") == "true")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_172.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_172.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_172.habboCommunication.habboWebLogin(name,password);
         var_113 = new SSOTicket(var_172.assets,_loc2_,_loc1_);
         var_113.addEventListener(SSOTicket.const_353,onParsedTicketSuccess);
         var_113.addEventListener(SSOTicket.const_279,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_172.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_172.windowManager.buildFromXML(_loc3_.content as XML);
