package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_740:IAssetLibrary;
      
      private var var_894:uint = 0;
      
      private var var_621:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_740.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_35)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_411));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_740.loadAssetFromFile("hotel_view_banner_" + var_894,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      {
         var _loc3_:AssetLoaderStruct = var_740.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
