package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2093)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1336,var_2092));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1456,"/");
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1456,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1336 = _habboConfiguration.getKey("flash.client.url","");
         var_2092 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_180 == null)
         {
         ...
         if(var_754 != null)
         {
            var_62.mode = HabboConnectionType.const_430;
            var_62.initConnection(HabboConnectionType.const_260);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1569 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_598);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_62.mode)
         {
            case HabboConnectionType.const_430:
               _loc6_ = "";
               ...
               var_1097 = _loc4_;
               var_180.loadBannerImage(_loc7_ + "?token=" + var_1097,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_870:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1417:
               var_627 = generateRandomHexString(30);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1097);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_870;
            }
         }
         var_62.initConnection(HabboConnectionType.const_260);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_105,onRoomSessionEnded);
      }
