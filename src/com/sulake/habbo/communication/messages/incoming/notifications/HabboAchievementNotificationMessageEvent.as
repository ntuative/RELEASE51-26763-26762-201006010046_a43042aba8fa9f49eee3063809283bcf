package com.sulake.habbo.communication.messages.incoming.notifications
{
   ...
   public class HabboAchievementNotificationMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (var_7 as HabboAchievementNotificationMessageParser).type;
      }
      
      public function get level() : int
      {
         return (var_7 as HabboAchievementNotificationMessageParser).level;
      }
      
      public function get method_7() : String
      {
         return (var_7 as HabboAchievementNotificationMessageParser).method_7;
      }
      
      public function get badgeID() : String
      {
         return (var_7 as HabboAchievementNotificationMessageParser).badgeID;
      }
   }
}
