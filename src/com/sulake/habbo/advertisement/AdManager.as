package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_912:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_496,0,0,_loc4_,var_1562,var_911,var_912));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2089 = int(_config.getKey("interstitial.interval","30000"));
         var_2087 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1334 = _loc2_.imageUrl;
         var_1562 = _loc2_.clickUrl;
         if(var_1334 != "" && var_1562 != "")
         {
            _loc3_ = var_1334;
            ...
            _loc4_ = new URLRequest(var_1334);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_447,0,0,param1.bitmapData,var_2088));
            var_751 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_912 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1561 > 0 && var_1563 >= var_1561)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_751;
         if(_loc1_ > var_2089)
         {
            ++var_1563;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_380));
         }
      }
