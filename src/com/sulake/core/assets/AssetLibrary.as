package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_854:String = "AssetLibraryReady";
      
      public static const const_1231:String = "AssetLibraryUnloaded";
      
      public static const const_476:String = "AssetLibraryLoaded";
      ...
      private var var_469:Boolean = true;
      
      private var var_335:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_394 = new Dictionary(false);
         var_676 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_393)
         {
            _loc4_ = AssetTypeDeclaration(var_393[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_394)
         {
            _loc2_ = var_394[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_394[_loc1_];
         }
         for(_loc1_ in var_125)
         {
            delete var_125[_loc1_];
         }
         for(_loc1_ in var_676)
         {
            delete var_676[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
         ...
         _isReady = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1231));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_468 = _loc2_.manifest.copy();
         var_335 = _loc2_.resource;
         if(var_469)
         {
            AssetLibrary.fetchLibraryContents(this,var_468,var_335);
         }
         _isReady = true;
         dispatchEvent(new Event(AssetLibrary.const_476));
         dispatchEvent(new Event(AssetLibrary.const_854));
         if(var_469)
         {
            if(!disposed)
            {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_394[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_987,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_394[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_393.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_393[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_336.length ? getAssetByName(var_336[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_393)
         {
            _loc3_ = AssetTypeDeclaration(var_393[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_676[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1420);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_468.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_335[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_394[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_125)
            {
               if(var_125[_loc2_] == param1)
               {
                  var_336.splice(var_336.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_393[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_335 != null ? false : false;
      }
   }
}
