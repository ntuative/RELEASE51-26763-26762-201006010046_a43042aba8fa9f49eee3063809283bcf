package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_643 = new Array();
         var_1607 = new Point();
         var_1608 = new Rectangle();
         var_323 = new Rectangle();
         var_324 = new Dictionary(true);
         var_713 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_324[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_643.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_323.x = _loc3_.dirty.x;
               var_323.y = _loc3_.dirty.y;
               var_323.width = _loc3_.dirty.width;
               var_323.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_323);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_615,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_324[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1607,var_1608))
            {
               if(param2.render(param1,var_1607,var_1608))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_713);
            var_324[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_615,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_323.x = param2.x - param1.x;
            var_323.y = param2.y - param1.y;
            var_323.width = param2.width;
            var_323.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_36))
            {
               while(param1.testParamFlag(WindowParam.const_36))
               {
                  ...
                  var_323.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_323,WindowRedrawFlag.const_251);
