package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1601 = new Dictionary();
         var_2230 = new Dictionary();
         TypeCodeTable.fillTables(var_1601,var_2230);
         var_1383 = new Dictionary();
         var_2229 = new Dictionary();
         StateCodeTable.fillTables(var_1383,var_2229);
         ...
         if(var_386 == null)
         {
            ...
            var_386.push(WindowState.const_71);
            var_386.push(WindowState.const_100);
            var_386.push(WindowState.WINDOW_STATE_SELECTED);
            var_386.push(WindowState.const_85);
            var_386.push(WindowState.const_79);
            var_386.push(WindowState.const_94);
            var_386.push(WindowState.const_89);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1383)
         {
            _loc3_.push(var_1383[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1601[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_769[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_769[param1] = new Array(SkinContainer.MAX_STYLE_COUNT);
         }
         var_769[param1][param2] = param3;
         if(true)
         {
            var_770[param1] = new Array(SkinContainer.MAX_STYLE_COUNT);
         }
         var_770[param1][param2] = param4;
      }
