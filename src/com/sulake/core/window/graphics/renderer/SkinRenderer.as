package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      {
         var _loc3_:ISkinTemplate = var_330[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_330)
         {
            ISkinTemplate(var_330[_loc1_]).dispose();
            delete var_330[_loc1_];
         }
         var_330 = null;
         var_329 = null;
      }
