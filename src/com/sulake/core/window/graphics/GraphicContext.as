package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_823:uint = 256;
      
      protected static var var_666:uint = 0;
      
      protected static var var_385:uint = 0;
      
      public static const const_982:uint = 2;
      
      public static const const_1675:uint = 128;
      
      public static const const_1640:uint = 64;
      
      public static const const_724:uint = 4;
      
      public static const const_1335:uint = 0;
      
      public static const const_1240:uint = 16;
      
      public static const const_622:uint = 1;
      
      public static const const_1211:uint = 8;
         ...
         if(var_663)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1641,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1641,16777215);
                  }
                  var_385 += bitmap.width * bitmap.height * 4;
               }
