package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1692:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1630:String = "_TEMP";
      ...
      protected var var_1131:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_967:Dictionary;
      
      protected var var_1409:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1408:Dictionary;
      
      protected var var_1132:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1131 = new Dictionary();
         TypeCodeTable.fillTables(var_1132,var_1131);
         var_967 = new Dictionary();
         var_1408 = new Dictionary();
         ParamCodeTable.fillTables(var_967,var_1408);
         var_1409 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1065,"");
         return param1.replace(const_1066,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1132)
            {
               delete var_1132[_loc1_];
            }
            for(_loc1_ in var_1131)
            {
               delete var_1131[_loc1_];
            }
            for(_loc1_ in var_967)
            {
               delete var_967[_loc1_];
            }
            for(_loc1_ in var_1408)
            {
               delete var_1408[_loc1_];
            }
            var_1409.dispose();
            var_1409 = null;
            var_16 = null;
