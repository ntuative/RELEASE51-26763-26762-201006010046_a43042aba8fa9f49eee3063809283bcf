package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1444:Boolean = false;
      ...
      protected var var_2384:Number = 0.0;
      
      protected var var_561:Boolean = false;
      
      protected var var_2385:Number = 0.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _container = var_16.create("_CONTAINER","",WindowType.const_357,WindowStyle.const_317,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_266,containerEventHandler);
         _container.addEventListener(WindowEvent.const_437,containerEventHandler);
         resizeOnItemUpdate = var_1142;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_266,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1056,_spacing,PropertyStruct.const_67,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1057,var_791,PropertyStruct.const_62,var_791 != const_1443));
         _loc1_.push(new PropertyStruct(const_1055,var_561,PropertyStruct.const_62,var_561 != const_1444));
         _loc1_.push(new PropertyStruct(const_1058,var_1142,PropertyStruct.const_62,var_1142 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1058:
                  ...
                  break;
               case const_1057:
                  var_791 = _loc2_.value as Boolean;
                  break;
            }
         }
