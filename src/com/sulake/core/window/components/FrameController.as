package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_817:String = "margin_top";
      
      private static const const_1170:String = "_HEADER";
      
      private static const const_815:String = "margin_right";
      ...
      private static const const_814:String = "margin_bottom";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_817,_loc3_.top,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_815,0 - _loc3_.right,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_814,0 - _loc3_.bottom,PropertyStruct.const_67,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_250);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1401 == null)
         {
            var_1401 = findChildByTag(const_1170) as IHeaderWindow;
            if(!var_1401)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_268,false);
         }
      ...
      {
         return content != null && var_1419 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1169) as IWindowContainer;
            if(!var_20)
            {
