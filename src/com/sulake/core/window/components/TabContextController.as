package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1140:String = "content";
      
      private static const const_1139:String = "selector";
       
      
      private var var_1389:Boolean = false;
      
      protected var var_974:ITabSelectorWindow;
      
      private var var_803:Boolean = false;
      
      protected var var_1640:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1640 == null)
         {
            var_1640 = findChildByTag(TabContextController.const_1140) as IWindowContainer;
         }
         return var_1640;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_974 == null)
         {
            var_974 = findChildByTag(TabContextController.const_1139) as ITabSelectorWindow;
            if(var_974 != null)
            {
               var_974.procedure = selectorEventProc;
            }
         }
         return var_974;
      }
      ...
      {
         return !!var_803 ? selector.iterator : null;
      }
