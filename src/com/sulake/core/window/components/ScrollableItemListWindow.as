package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_939:IItemListWindow;
      
      private var var_371:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_371)
         {
            var_371 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_371)
            {
               var_371.addEventListener(WindowEvent.const_253,scrollBarEventProc);
               var_371.addEventListener(WindowEvent.const_235,scrollBarEventProc);
            }
         }
         return var_371;
      }
      ...
      override public function dispose() : void
      {
         if(var_371)
         {
            var_371.removeEventListener(WindowEvent.const_253,scrollBarEventProc);
            var_371.removeEventListener(WindowEvent.const_235,scrollBarEventProc);
            var_371 = null;
         }
         if(var_939)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_939)
         {
            var_939 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_939;
      }
