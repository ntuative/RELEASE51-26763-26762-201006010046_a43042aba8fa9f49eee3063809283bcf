package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2386:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_659 * maxScrollH,var_383 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_789)
         {
            context.removeLocalizationListener(var_328,this);
         }
         if(var_69 != null)
         {
            var_69.dispose();
      ...
      {
         var_659 = param1;
         _field.scrollH = var_659 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_328 = param1;
         if(var_328.charAt(0) == "$" && var_328.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_328.slice(2,var_328.indexOf("}")),this);
            var_789 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_834,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_403,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_403,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_625,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_625,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_625,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_659 = var_659;
         _loc1_.var_383 = var_383;
