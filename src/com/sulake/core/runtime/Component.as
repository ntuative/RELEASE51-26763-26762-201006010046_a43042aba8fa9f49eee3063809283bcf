package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1021:uint = 4;
      ...
      protected var var_1836:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_970 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_970);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1141 & const_1021)
         {
            if(_loc3_ == 0)
            {
