package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_899:IProtocolDecoder;
      ...
      {
         return var_899.readShort(_data);
      }
      
      public function readString() : String
      {
         return var_899.readString(_data);
      }
      
      public function readInteger() : int
      {
         return var_899.readInteger(_data);
      }
      
      public function readBoolean() : Boolean
      {
         return var_899.readBoolean(_data);
      }
